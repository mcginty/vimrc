...
dir::
	...
	wget -O - https://github.com/mcginty/vimrc/raw/master/autoinstall.sh | sh
...
1. Clone this repo::
   	...
   	git clone git://github.com/mcginty/vimrc.git

   or download the plain source only::

   	wget -qO - http://github.com/mcginty/vimrc/tarball/master | tar -xzvf -
